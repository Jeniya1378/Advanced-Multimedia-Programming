...
def main():
    ...
    p_stft, freq_axis_p = stft(p_frames, FFT_LEN, p_fs)

    w_frames = enframe(w_wav, int(0.01*w_fs), int(0.035*w_fs))
    w_stft, freq_axis_w = stft(w_frames, FFT_LEN, w_fs)

    plot_stft(w_stft, freq_axis_w, p_stft, freq_axis_p,"STFT of White Fang",
              "STFT of Pride and Prejudice")
