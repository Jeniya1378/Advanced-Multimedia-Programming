...
def stft(frames, fft_len, fs):
    ...
    stft_frames = None  #Write code to call scipy.rfft over the frames...
...
def sgram(x, frame_skip, frame_length, fft_length, fs, max_freq):
    frames = None  #Get a list of windowed frames
    spectra, freq_axis = None  #Use stft
    sgram = None  #Set the levels on the spectra and convert to log dB
